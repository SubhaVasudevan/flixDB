...
public class SocketServer
{
    ...
    private NetworkHandlerInterface handler;
     ...
     */
    public void addHandler(NetworkHandlerInterface handler) {
    ...
    /**
     * Accept and enqueue requests as jobs to be serviced asynchronously.
